...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:3,spmd:0,trmd:1,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:True,rprd:True,enco:False,rmgx:True,imps:True,rpth:1,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.6509434,fgcg:0.6509434,fgcb:0.6509434,fgca:1,fgde:0.05,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:9399,x:32719,y:32712,varname:node_9399,prsc:2|diff-8571-RGB,spec-9689-RGB,gloss-2914-OUT,normal-7206-OUT;n:type:ShaderForge.SFN_Slider,id:2914,x:32218,y:32958,ptovrint:False,ptlb:Gloss Amount,ptin:_GlossAmount,varname:node_2914,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Color,id:9689,x:32375,y:32475,ptovrint:False,ptlb:Specular Color,ptin:_SpecularColor,varname:_node_2314_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Tex2dAsset,id:9344,x:30204,y:32609,ptovrint:False,ptlb:Wave Normals,ptin:_WaveNormals,varname:node_9344,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:2dd3788f8589b40bf82a92d76ffc5091,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:9564,x:30492,y:32600,varname:node_9564,prsc:2,tex:2dd3788f8589b40bf82a92d76ffc5091,ntxv:0,isnm:False|UVIN-5163-OUT,TEX-9344-TEX;n:type:ShaderForge.SFN_Tex2d,id:7724,x:30492,y:32724,varname:node_7724,prsc:2,tex:2dd3788f8589b40bf82a92d76ffc5091,ntxv:0,isnm:False|UVIN-1597-UVOUT,TEX-9344-TEX;n:type:ShaderForge.SFN_Blend,id:649,x:30694,y:32665,varname:node_649,prsc:2,blmd:8,clmp:False|SRC-9564-RGB,DST-7724-RGB;n:type:ShaderForge.SFN_Panner,id:8217,x:30047,y:32568,varname:node_8217,prsc:2,spu:1,spv:0|UVIN-637-UVOUT,DIST-6665-OUT;n:type:ShaderForge.SFN_Panner,id:1597,x:30086,y:32819,varname:node_1597,prsc:2,spu:0,spv:1|UVIN-55-UVOUT,DIST-6665-OUT;n:type:ShaderForge.SFN_TexCoord,id:637,x:29818,y:32584,varname:node_637,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_TexCoord,id:55,x:29818,y:32831,varname:node_55,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Time,id:5188,x:29519,y:32716,varname:node_5188,prsc:2;n:type:ShaderForge.SFN_Slider,id:4937,x:29494,y:32601,ptovrint:False,ptlb:Wave Scroll Speed,ptin:_WaveScrollSpeed,varname:node_4937,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:0.3;n:type:ShaderForge.SFN_Multiply,id:6665,x:29701,y:32716,varname:node_6665,prsc:2|A-4937-OUT,B-5188-TSL;n:type:ShaderForge.SFN_Slider,id:6820,x:30849,y:32840,ptovrint:False,ptlb:Wave Intensity,ptin:_WaveIntensity,varname:node_6820,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:1,cur:1,max:1.5;n:type:ShaderForge.SFN_Lerp,id:6711,x:31249,y:32743,varname:node_6711,prsc:2|A-649-OUT,B-2049-OUT,T-6820-OUT;n:type:ShaderForge.SFN_Vector3,id:2049,x:30851,y:32737,varname:node_2049,prsc:2,v1:0,v2:0,v3:1;n:type:ShaderForge.SFN_Multiply,id:5163,x:30273,y:32451,varname:node_5163,prsc:2|A-8217-UVOUT,B-7056-OUT;n:type:ShaderForge.SFN_Vector1,id:7056,x:30047,y:32714,varname:node_7056,prsc:2,v1:1.2;n:type:ShaderForge.SFN_Tex2dAsset,id:6660,x:30213,y:32228,ptovrint:False,ptlb:Detail Normals,ptin:_DetailNormals,varname:_WaveNormals_copy,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:2dd3788f8589b40bf82a92d76ffc5091,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Blend,id:2059,x:30663,y:32201,varname:node_2059,prsc:2,blmd:8,clmp:False|SRC-2498-RGB,DST-6823-RGB;n:type:ShaderForge.SFN_Panner,id:6697,x:30010,y:32107,varname:node_6697,prsc:2,spu:1,spv:0|UVIN-4528-UVOUT,DIST-9285-OUT;n:type:ShaderForge.SFN_Panner,id:6125,x:30049,y:32358,varname:node_6125,prsc:2,spu:0,spv:1|UVIN-5877-UVOUT,DIST-9285-OUT;n:type:ShaderForge.SFN_TexCoord,id:4528,x:29701,y:31920,varname:node_4528,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_TexCoord,id:5877,x:29781,y:32370,varname:node_5877,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Time,id:1568,x:29356,y:32207,varname:node_1568,prsc:2;n:type:ShaderForge.SFN_Slider,id:3757,x:29456,y:32140,ptovrint:False,ptlb:Detail Scroll Speed,ptin:_DetailScrollSpeed,varname:_NormalScrollSpeed_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:0.3;n:type:ShaderForge.SFN_Multiply,id:9285,x:29663,y:32254,varname:node_9285,prsc:2|A-3757-OUT,B-1568-TSL;n:type:ShaderForge.SFN_Multiply,id:8611,x:30213,y:32074,varname:node_8611,prsc:2|A-6697-UVOUT,B-2304-OUT;n:type:ShaderForge.SFN_Vector1,id:2304,x:30010,y:32253,varname:node_2304,prsc:2,v1:1.2;n:type:ShaderForge.SFN_Tex2d,id:2498,x:30454,y:32117,varname:node_2498,prsc:2,tex:2dd3788f8589b40bf82a92d76ffc5091,ntxv:0,isnm:False|UVIN-8611-OUT,TEX-6660-TEX;n:type:ShaderForge.SFN_Tex2d,id:6823,x:30438,y:32287,varname:node_6823,prsc:2,tex:2dd3788f8589b40bf82a92d76ffc5091,ntxv:0,isnm:False|UVIN-6125-UVOUT,TEX-6660-TEX;n:type:ShaderForge.SFN_Vector3,id:7666,x:30851,y:32428,varname:node_7666,prsc:2,v1:0,v2:0,v3:1;n:type:ShaderForge.SFN_Lerp,id:4953,x:31249,y:32487,varname:node_4953,prsc:2|A-2059-OUT,B-7666-OUT,T-8940-OUT;n:type:ShaderForge.SFN_Slider,id:8940,x:30831,y:32526,ptovrint:False,ptlb:Detail Intensity,ptin:_DetailIntensity,varname:_WaveIntensity_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:1,cur:1,max:1.5;n:type:ShaderForge.SFN_Blend,id:9738,x:31507,y:32622,varname:node_9738,prsc:2,blmd:8,clmp:False|SRC-4953-OUT,DST-6711-OUT;n:type:ShaderForge.SFN_Color,id:8571,x:32375,y:32636,ptovrint:False,ptlb:Base Color,ptin:_BaseColor,varname:node_8571,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Lerp,id:8487,x:31130,y:31667,varname:node_8487,prsc:2|A-6451-OUT,B-3587-OUT,T-5296-OUT;n:type:ShaderForge.SFN_Vector3,id:3587,x:30732,y:31661,varname:node_3587,prsc:2,v1:0,v2:0,v3:1;n:type:ShaderForge.SFN_Blend,id:6451,x:30575,y:31589,varname:node_6451,prsc:2,blmd:8,clmp:False|SRC-4502-RGB,DST-7637-RGB;n:type:ShaderForge.SFN_Multiply,id:3213,x:30154,y:31375,varname:node_3213,prsc:2|A-3361-UVOUT,B-8750-OUT;n:type:ShaderForge.SFN_Panner,id:3361,x:29909,y:31484,varname:node_3361,prsc:2,spu:1,spv:0|UVIN-5315-UVOUT,DIST-8964-OUT;n:type:ShaderForge.SFN_Panner,id:6353,x:29967,y:31743,varname:node_6353,prsc:2,spu:0,spv:1|UVIN-937-UVOUT,DIST-8964-OUT;n:type:ShaderForge.SFN_TexCoord,id:5315,x:29699,y:31508,varname:node_5315,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_TexCoord,id:937,x:29699,y:31755,varname:node_937,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:8964,x:29582,y:31640,varname:node_8964,prsc:2|A-953-OUT,B-7107-TSL;n:type:ShaderForge.SFN_Time,id:7107,x:29400,y:31640,varname:node_7107,prsc:2;n:type:ShaderForge.SFN_Slider,id:953,x:29375,y:31525,ptovrint:False,ptlb:Minute Detail Scroll Speed,ptin:_MinuteDetailScrollSpeed,varname:_WaveScrollSpeed_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:0.3;n:type:ShaderForge.SFN_Vector1,id:8750,x:29909,y:31637,varname:node_8750,prsc:2,v1:1.2;n:type:ShaderForge.SFN_Blend,id:7206,x:31765,y:32327,varname:node_7206,prsc:2,blmd:8,clmp:False|SRC-8487-OUT,DST-9738-OUT;n:type:ShaderForge.SFN_Tex2d,id:4502,x:30375,y:31478,varname:node_4502,prsc:2,tex:fb6566c21f717904f83743a5a76dd0b0,ntxv:0,isnm:False|UVIN-3213-OUT,TEX-4606-TEX;n:type:ShaderForge.SFN_Tex2d,id:7637,x:30370,y:31668,varname:node_7637,prsc:2,tex:fb6566c21f717904f83743a5a76dd0b0,ntxv:0,isnm:False|UVIN-6353-UVOUT,TEX-4606-TEX;n:type:ShaderForge.SFN_Tex2dAsset,id:4606,x:30111,y:31586,ptovrint:False,ptlb:Minute Detail Normals,ptin:_MinuteDetailNormals,varname:node_4606,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:fb6566c21f717904f83743a5a76dd0b0,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Slider,id:5296,x:30715,y:31848,ptovrint:False,ptlb:Minute Detail Intensity,ptin:_MinuteDetailIntensity,varname:node_5296,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:1,cur:1,max:1.5;n:type:ShaderForge.SFN_Vector1,id:3115,x:30138,y:32381,varname:node_3115,prsc:2,v1:1.2;n:type:ShaderForge.SFN_Vector1,id:9093,x:30202,y:32445,varname:node_9093,prsc:2,v1:1.2;n:type:ShaderForge.SFN_Vector1,id:3628,x:30266,y:32509,varname:node_3628,prsc:2,v1:1.2;proporder:8571-9689-2914-9344-6820-4937-6660-8940-3757-4606-5296-953;pass:END;sub:END;*/

Shader "Custom/Water Pro" {
    Properties {
        _BaseColor ("Base Color", Color) = (0.5,0.5,0.5,1)
        _SpecularColor ("Specular Color", Color) = (0.5,0.5,0.5,1)
        _GlossAmount ("Gloss Amount", Range(0, 1)) = 0
        _WaveNormals ("Wave Normals", 2D) = "bump" {}
        _WaveIntensity ("Wave Intensity", Range(1, 1.5)) = 1
        _WaveScrollSpeed ("Wave Scroll Speed", Range(0, 0.3)) = 0
        _DetailNormals ("Detail Normals", 2D) = "bump" {}
        _DetailIntensity ("Detail Intensity", Range(1, 1.5)) = 1
        _DetailScrollSpeed ("Detail Scroll Speed", Range(0, 0.3)) = 0
        _MinuteDetailNormals ("Minute Detail Normals", 2D) = "bump" {}
        _MinuteDetailIntensity ("Minute Detail Intensity", Range(1, 1.5)) = 1
        _MinuteDetailScrollSpeed ("Minute Detail Scroll Speed", Range(0, 0.3)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
